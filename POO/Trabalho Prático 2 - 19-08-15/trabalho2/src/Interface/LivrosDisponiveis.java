 ...
 * @author Eymar Lima
 */
public class LivrosDisponiveis extends javax.swing.JDialog {

    /**
     * Creates new form LivrosDisponiveis
     */
    public LivrosDisponiveis(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagens/1437781152_f-check_2566.png"))); // NOI18N
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        livros = control.getLivrosDisponiveis();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                LivrosDisponiveis dialog = new LivrosDisponiveis(new javax.swing.JFrame(), true);
